...
npx openapi-generator-cli generate -i ./spec.json -g typescript-angular -o service --additional-properties=fileNaming=camelCase,ngVersion=10.0.0,stringEnums=true --enable-post-process-file --remove-operation-id-prefix
